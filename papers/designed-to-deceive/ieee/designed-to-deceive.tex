...
\begin{IEEEkeywords}
social robots, metaphor hacking, social failure modes, domestic privacy, companion framing, dark patterns, anthropomorphism, value sensitive design, surveillance, informed consent
\end{IEEEkeywords}

\section{Introduction}

Domestic social robots present a novel challenge to the norms governing private life. Unlike earlier generations of household technology, social robots are designed not merely to perform tasks but to occupy relational roles within the home: to be perceived as agents, companions, and presences rather than as tools~\cite{ananto_robot_2020}. This relational ambition is not incidental to the technology's commercial strategy; it is central to it. As Jones and Millar~\cite{jones_hacking_2017} observe, science and technology innovations begin with metaphors that compare the old and familiar to the new and unfamiliar, and each choice of metaphor maps onto a particular set of values and perspectives. The choice to frame a domestic robot as a companion rather than a device is a normative decision with material consequences.
...
The author thanks \href{https://craiedl.ca/team/caitlin-heppner}{Caitlin Heppner} and \href{https://craiedl.ca/team/jason-millar}{Dr.\ Jason Millar} of the \href{https://craiedl.ca}{Canadian Robotics and Artificial Intelligence Ethical Design Lab (CRAiEDL)} at the University of Ottawa for their instruction and guidance in the proceedings of the Ethics for Design, AI and Robotics sessions. The theoretical frameworks central to this paper, including the social failure mode framework and Metaphor Hacking methodology, were developed in part by Dr.\ Millar and introduced through the course.
