...
\begin{itemize}
    ...
    \item \textbf{Population Density (20\%):} Census tract population distributions from \gls{sc}'s Census Profile \cite{statcan2021}.
    
    \item \textbf{Regional Transit Accessibility (15\%):} Distance to major transit nodes from data provided by \gls{grt-open}.
    
    \item \textbf{Infrastructure Age (5\%):} Based on building age data from census. \cite{statcan2021}
\end{itemize}
