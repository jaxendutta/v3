...
The five pipeline components of \gls{ner} (F1-improving for biomedical embeddings), classification (F1 = 0.69, 19 specialties), clustering (55 coherent topics), \gls{rag} ($+11$\gls{pp} under optimal conditions), and \gls{knnb} recommender (HR@10 = 0.740) constitute a functional, evaluated, and reproducible medical study agent.
