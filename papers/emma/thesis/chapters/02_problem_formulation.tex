...
This project builds directly on the \gls{amg-rag} methodology introduced by \citet{rezaei_agentic_2025}, using the same MedQA-\gls{usmle} and MedMCQA datasets. The choice to frame \gls{emma} as a study agent rather than a triaging system reflects the nature of these datasets: their multiple-choice structure, specialty labels, and associated textbook corpus are ideally suited to exam preparation rather than clinical decision support.
