...
export default function TechStackSection({ id, techStack }: TechStackSectionProps) {
    return (
        <section
            id={id}
            // Matches your ShowcaseLayout snapping perfectly
            className="relative snap-start shrink-0 w-screen h-[calc(100vh-120px)] flex flex-col justify-center gap-8 md:gap-12 px-6 md:px-12 py-12 md:py-24 bg-background text-foreground overflow-hidden"
        >
