// src/components/sections/talks/TalkDetailContent.tsx
"use client";
...
export default function TalkDetailContent({ talkId }: { talkId: string }) {
    ...
    return (
        <div className="min-h-screen flex flex-col gap-8 px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 pb-4 md:pb-6 lg:pb-8 xl:pb-12 2xl:pb-16 pt-[calc(env(safe-area-inset-top,0px)+4.75rem)] md:pt-16 text-[13px] md:text-sm lg:text-base">
            ...
            >
                <RotatingButton href="/papers" texts={["Papers & Talks", "Back"]} centerIcon={HiOutlineArrowLeft} size={80} fontSize={12} variant="wavy" />
            </motion.div>
            ...
            <motion.div
                ...
                transition={{ duration: 0.35, ease: "easeOut" }}
            >
                <RotatingButton href="#top" texts={["Back to top", "Scroll up"]} centerIcon={HiOutlineArrowUp} size={80} fontSize={12} variant="wavy" />
            </motion.div>
