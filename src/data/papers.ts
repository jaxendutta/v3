...
export const papersData: PapersData = {
    "emma": {
        ...
        shortTitle: "EMMA",
        subtitle: "Emergency Medicine Mentoring Agent",
        abstract:
    ...
    "beyond-helpful": {
        ...
        shortTitle: "Beyond Helpful",
        subtitle: "Ethical Violations in Parasocial Companionships with Affective Virtual Agents",
        abstract:
    ...
    "not-your-trolleys-problem": {
        ...
        subtitle: "A Multi-Domain Ethics Framework for Autonomous Vehicles",
        abstract:
    ...
    "solarwinds-confronts-sunburst": {
        ...
        subtitle: "A Post-Mortem Analysis",
        abstract:
    ...
    "prompt-based-web-services-and-api-design": {
        ...
        shortTitle: "Prompt-Based Web Services and API Design",
        subtitle: "A New Paradigm for Natural Language Interfaces",
    ...
    "designed-to-deceive": {
        ...
        shortTitle: "Designed to Deceive",
        subtitle: "Social Failure Modes and the Metaphors That Enable Them in Domestic Social Robots",
        abstract:
    ...
    "mind-the-gap": {
        ...
        subtitle: "A Structured Survey of AI Mental Health Technologies and Their Equity Failures for Marginalized Populations",
        abstract:
    ...
    "human-centered-theater": {
        ...
        shortTitle: "Human-Centered Theater",
        subtitle: "Overcoming Organizational Resistance to Authentic UX",
        abstract:
    ...
    "evse-opt": {
        ...
        shortTitle: "EVSE Network Optimization in the KWC CMA",
        subtitle: "A Multi-Phase Approach to Infrastructure Planning",
        abstract:
    ...
    "qcc-dde": {
        ...
        shortTitle: "Relapse Thresholds in QCC Dormancy",
        subtitle: "A DDE Model for Tumor Growth",
        abstract:
    ...
    "i-knew-how-to-report-but-didnt": {
        ...
        subtitle: "Awareness, Helplessness, and Platform Distrust in CSAM Reporting Among University Students",
        abstract:
    ...
    "a-symphony-of-safeguards": {
        ...
        shortTitle: "A Symphony of Safeguards",
        subtitle: "The Case for Multi-Layered AI Regulation",
        abstract:
    ...
    "data-for-whom": {
        ...
        shortTitle: "Data for Whom?",
        subtitle: "Responsible Data Collection in the Global South",
        abstract:
    ...
    "handle-with-care": {
        ...
        subtitle: "The Conditional Case for Mental Health Chatbots in Personal Treatment",
        abstract:
    ...
    "rooted-in-the-land": {
        ...
        shortTitle: "Rooted in the Land",
        subtitle: "Redesigning GPS Through Indigenous Perspectives",
        abstract:
    ...
    "healing-the-algorithm": {
        ...
        shortTitle: "Healing the Algorithm",
        subtitle: "The Case for Comprehensive Metrics and Explainable AI in Healthcare Allocation",
        abstract:
    ...
    "holistic-fairness": {
        ...
        shortTitle: "Holistic Fairness",
        subtitle: "Why Neither Equality Nor Process Is Enough",
        abstract:
