...
\begin{enumerate}
    ...
    \item \tinypara{GV.SC (Cybersecurity Supply Chain Risk Management) [Absent]:} The most critical governance failure. SolarWinds operated without a formal C-SCRM program per \gls{nist} SP 800-161r1, resulting in no SBOM tracking, no supplier risk assessment, and no ongoing supply chain monitoring \cite{boyens2024}.
