...
The datasets used are MedQA-\gls{usmle} \cite{jin2021} and MedMCQA \cite{pal2022}, both of which are also used for benchmark evaluation in the \gls{amg-rag} methodology of \citet{rezaei2025}. MedQA is a multiple-choice question answering dataset derived from professional medical licensing examinations \cite{jin2021}, and its questions were written in reference to a collection of 18 standard medical textbooks. MedMCQA is built from medical entrance examination data and covers both foundational and clinical knowledge across a broad range of medical specialties \cite{pal2022}.
